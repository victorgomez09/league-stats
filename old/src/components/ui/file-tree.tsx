										...
										<AccordionPrimitive.Item value={item.id}>
											<AccordionTrigger
												className={cn(
													...
													"before:opacity-100 before:bg-accent before:border-l-2 before:border-l-accent-foreground/50 dark:before:border-0",
												)}
...
>(({ className, item, isSelected, Icon, ...props }, ref) => {
	return (
		<button
			...
			hover:before:opacity-100 before:absolute before:left-0 before:right-1 before:w-full transition-colors before:opacity-0 before:bg-muted/80 before:h-[1.75rem] before:-z-10 rounded-md focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 relative focus-visible:z-10 w-full",
				className,
				isSelected &&
				"before:opacity-100 before:bg-accent bg-border rounded-md text-accent before:border-l-2 before:border-l-accent-foreground/50 dark:before:border-0",
			)}
			{...props}
		>
			{item.icon && (
				<item.icon
					className="h-4 w-4 shrink-0 mr-2" aria-hidden="true"
				/>
			)}
			{!item.icon && Icon && (
				<Icon
